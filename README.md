...
# Configuration
Bot configuration is done via the a YAML file. By default, the bot looks for a file called `config.yaml` in the current working directory. The config file location can be overriden with the `P1CHTO_CONFIG_FILE` environment variable.
